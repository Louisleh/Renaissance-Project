// Renaissance Skills — lightweight offline shell.
// Strategy: cache-first for app shell assets, network-first for navigation requests.

const CACHE_VERSION = 'renaissance-v1';
